...
const itinerariesController = {
    ...
    loadItinerary: async(req,res)=>{         /* Controlador para cargar una nueva ciudad desde el front. */
        ...
        const {name, image, description,imageUser,userName,price,hashtags,hours,cityId} = req.body
        new itineraries({name, image, description,imageUser,userName,price,hashtags,hours,cityId}).save()   /* salva  */
